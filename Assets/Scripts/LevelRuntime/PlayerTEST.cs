...
public class PlayerTEST : MonoBehaviour
{
    ...
    private static PlayerTEST player;
    ...
    private void Awake()
    {
        ...
        {
            player = this;
            Debug.Log("Dont destroy the player");
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        switch (collision.collider.tag)
        {
            case "Enemy":
                ...
                {
                    Debug.Log(health);
                    UIController.controller.Damage();
                    health -= 1;
                    ...
                    if (health == 0)
                    {
                        ...
                        health = 3;
                        UIController.controller.Restart();
                    }
                }
                break;
